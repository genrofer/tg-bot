        ...
        if (item.user_id == chatId) {
            ...
            if (item.connected != 0 && msg.text != '/suhbatdosh' && msg.text != '/start' && msg.text != '/stop') {
                ...
                if (msg.text) {
                    ...
                    setTimeout(() => {
                        bot.sendPhoto(item.connected, `C:/Users/Asus VivoBook/Desktop/telegram/src/images/${name}_${connectedUser.name}__${hour}_${minute}__${day}_${month}_${year}___${now}.jpg`)
                    }, 1000);
